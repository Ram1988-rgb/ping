...
<script>
  ...
  <script src="<?php echo ROUTE_STIE_PATH; ?>assets/js/status.js"></script>
...
<div class="wrapper">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#">
          ...
          <span class="badge badge-danger navbar-badge" id="badge-count"></span>
        </a>
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right" id="header-notification">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          ?>
          <li class="nav-item">
            <a href="<?php echo base_url('admin')?>/admin/index" class="nav-link <?php if($this->router->fetch_class() =='admin'){?>active<?php }?>">
              <img src="<?php echo base_url('assets/icons/person.png'); ?>" class="sidebar_icons" />
              <p> Users</p>
            </a>
          </li>
          <?php }
          if(getModulePermission('2',$this->session->userdata('ADMINID'))){
          ?>
          <li class="nav-item">
          ...
          <?php }
          if(getModulePermission('3',$this->session->userdata('ADMINID'))){
          ?>
          <li class="nav-item">
          ...
          <?php }
          if(1==2 && getModulePermission('4',$this->session->userdata('ADMINID'))){
          ?>
          <li class="nav-item">
          ...
          <?php }
          if(getModulePermission('5',$this->session->userdata('ADMINID'))){
          ?>
          <li class="nav-item">
          ...
          <?php }
          if(getModulePermission('6',$this->session->userdata('ADMINID'))){
          ?>
          <li class="nav-item">
            <a href="<?php echo base_url('admin/')?>loan" class="nav-link <?php if($this->router->fetch_class() =='loan' && $this->router->fetch_method() !='loan_history'){?>active<?php }?>">
              <img src="<?php echo base_url('assets/icons/loan.png'); ?>" class="sidebar_icons" />
              <p>Loan</p>
            </a>            
          </li>
          <?php }
          if(getModulePermission('7',$this->session->userdata('ADMINID'))){
          ?>
          <li class="nav-item">
          ...
          <?php }
          if(getModulePermission('8',$this->session->userdata('ADMINID'))){
          ?>
          <li class="nav-item">
          ...
          <?php }
          if(getModulePermission('9',$this->session->userdata('ADMINID'))){
          ?>
          <li class="nav-item">
          ...
          <?php }
          if(getModulePermission('10',$this->session->userdata('ADMINID'))){
          ?>
          <li class="nav-item">
          ...
          <?php }
          if(getModulePermission('11',$this->session->userdata('ADMINID'))){
          ?>
          <li class="nav-item">
          ...
          <?php }
          if(getModulePermission('12',$this->session->userdata('ADMINID'))){
          ?>
          <!-- <li class="nav-item">
          ...
          <li class="nav-item <?php if($this->router->fetch_class() =='logs'){?>menu-is-opening menu-open<?php }?>" >
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url($module)?>/logs/index" class="nav-link <?php if($this->router->fetch_class() =='logs' && ($this->router->fetch_method() =='detail')){?>active<?php }?>">
                  <i class="fas fa-user-friends"></i>
                  <p>Customer</p>
                </a>            
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url($module)?>/logs/agent" class="nav-link <?php if($this->router->fetch_class() =='logs' && ($this->router->fetch_method() =='agent_detail')){?>active<?php }?>">
                  <i class="fas fa-user-friends"></i>
                  <p>Agent</p>
                </a>            
              </li>
          ...
          ?>
           <?php
          if(getModulePermission('14',$this->session->userdata('ADMINID'))){
          ?>
          <!-- <li class="nav-item">
          ...
          <?php }?>
          <?php
          if(getModulePermission('13',$this->session->userdata('ADMINID'))){
          ?>
          <li class="nav-item <?php if($this->router->fetch_class() =='paymenttype' || $this->router->fetch_class() =='paymentduration'){?>menu-is-opening menu-open<?php }?>" >
            ...
            <ul class="nav nav-treeview">
              ...
              <img src="<?php echo base_url('assets/icons/sms.png'); ?>" class="sidebar_icons" />
               ...
               <li class="nav-item">
                <a href="<?php echo base_url('admin')?>/config/index" class="nav-link <?php if($this->router->fetch_class() =='config'){?>active<?php }?>">
              <img src="<?php echo base_url('assets/icons/mask_group_22.png'); ?>" class="sidebar_icons" />
          ...
          <li class="nav-item">
            <a href="<?php echo base_url($module)?>/fund" class="nav-link <?php if($this->router->fetch_class() =='fund' && $this->router->fetch_method() =='index'){?>active<?php }?>">
              <img src="<?php echo base_url('assets/icons/funding.png'); ?>" class="sidebar_icons" />
              <p>Cash</p>
            </a>            
          </li>
          ...
          <!--<li class="nav-item <?php if($this->router->fetch_method() !='fund_history' && ($this->router->fetch_class() =='cash' || $this->router->fetch_class() =='fund')){?>menu-is-opening menu-open<?php }?>" >
            <a href="#" class="nav-link">
              <img src="<?php echo base_url('assets/icons/mask_group_46.png'); ?>" class="sidebar_icons" />
              <p>
                Cash
          ...
          <li class="nav-item">
            <a href="<?php echo base_url($module)?>/investment/myinvestment" class="nav-link <?php if($this->router->fetch_class() =='investment'){?>active<?php }?>">
            <img src="<?php echo base_url('assets/icons/all_inbox.png'); ?>" class="sidebar_icons" />
          ...
          <li class="nav-item">
            <a href="<?php echo base_url($module)?>/loan/myloan" class="nav-link <?php if($this->router->fetch_class() =='loan' && $this->router->fetch_method() !='loan_history'){?>active<?php }?>">
            <img src="<?php echo base_url('assets/icons/loan.png'); ?>" class="sidebar_icons" />
          ...
          <li class="nav-item">
            <a href="<?php echo base_url($module)?>/interest/earned" class="nav-link <?php if($this->router->fetch_class() =='interest'){?>active<?php }?>">
         ...
         <li class="nav-item">
            <a href="<?php echo base_url($module)?>/fund/fund_history" class="nav-link <?php if($this->router->fetch_class() =='fund' && $this->router->fetch_method() =='fund_history'){?>active<?php }?>">
              <img src="<?php echo base_url('assets/icons/history.png'); ?>" class="sidebar_icons" />
              <p>History</p>
            </a>            
          </li>
          <li class="nav-item">
            <a href="<?php echo base_url($module)?>/loan/loan_history" class="nav-link <?php if($this->router->fetch_class() =='loan' && $this->router->fetch_method() =='loan_history'){?>active<?php }?>">
              <img src="<?php echo base_url('assets/icons/history.png'); ?>" class="sidebar_icons" />
              <p>Loan History</p>
            </a>            
          </li>
          ...
          <li class="nav-item">
            <a href="<?php echo base_url($module)?>/fund/account_report" class="nav-link <?php if($this->router->fetch_method() =='account_report'){?>active<?php }?>">
         ...
         <!-- <li class="nav-item">
          ...
          <?php if($module == "agent"){?>
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                <a href="<?php echo base_url($module)?>/fund/addfund" class="nav-link <?php if($this->router->fetch_method() =='addfund'){?>active<?php }?>">
                <img src="<?php echo base_url('assets/icons/mask_group_46.png'); ?>" class="sidebar_icons" />
                  <p>Add Fund</p>
                </a>
              </li>
  ...
  function showNotification(){
    $.ajax({
        type: "POST",
        url: baseURL+"user/dashboard/get_notification",
        data: {},
        dataType:"JSON",
        success: function(response) {
            ...
            if(response.total>0){
              $("#badge-count").html(response.total);
              
              for(let i=0; i< response.data.length;i++){
                if(i==5){
                  break;
                }
                data = data+`<a href="#" class="dropdown-item">
                  <!-- Message Start -->
                  <div class="media">                  
                    <div class="media-body">
                      <h3 class="dropdown-item-title">
                      ...
                      <p class="text-sm">${response.data[i].message}</p>
                      <p class="text-sm text-muted"><i class="far fa-clock mr-1"></i> ${response.data[i].createdAt}</p>
                    </div>
                  </div>
                  <!-- Message End -->
                </a>`
            ...
            data = data + `<div class="dropdown-divider"></div>
          <a href="<?php echo base_url('user/notification')?>" class="dropdown-item dropdown-footer">See All Messages</a>`;
