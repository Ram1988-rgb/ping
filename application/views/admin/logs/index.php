...
<div class="content-wrapper">
    ...
    <div class="content-header">
      ...
      <div class="search-container">
        <form action="" method="post">          
          <div class="row">
            ...
            <div class='col-sm-3'>
              ...
              <a href="<?php echo base_url('admin/logs/index')?>"><input type="button" value="Clear" class="btn btn-primary" style="margin-top:30px;" ></a>
            </div>
          </div>
          </form>
        </div>
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><img src="<?php echo base_url('assets/icons/logs-black.png'); ?>" class="sidebar_icons" />Customer Log</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <?php if($users){
                  ...
                  <tr>
                    ...
                    <td><a href="<?php echo base_url('admin/logs/detail/'.$line->id.$url)?>">
