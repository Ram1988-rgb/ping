                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <?php foreach($all_paymentType as $paymenttype){?>
                        <div class="d-flex align-items-center mb-2">
                            <input type="checkbox" name="paymenttype[]" class="" id="paymenttype" value="<?php echo $paymenttype->id?>" <?php if($this->plan_model->checkedPaymentType($detail->id,$paymenttype->id)){?>checked<?php }?>>
                  ...
                  <div class="form-group">
                    ...
                    <?php foreach($all_paymentDuration as $paymentduration){?>
                        <div class="d-flex align-items-center mb-2">
                          <input type="checkbox" name="paymentduration[]" class="" id="paymentduration" value="<?php echo $paymentduration->id?>"  data-validation="checkbox_group" data-suggestions="as" <?php if($this->plan_model->checkedDuration($detail->id,$paymentduration->id)){?>checked="checked"<?php }?> onchange="duration_change(this,'<?php echo $paymentduration->id?>_check')" data-validation-qty="min1">
                          <label class="ml-2 mb-0"><?php echo $paymentduration->label?></label>
                        </div>
                        <script>
                          $( document ).ready(function() {
                            $("[name='paymentduration[]']:eq(0)")
                              .valAttr('','validate_checkbox_group')
                              .valAttr('qty','1-4')
                              .valAttr('error-msg','please choose payment duration');
                          })
                        </script>
