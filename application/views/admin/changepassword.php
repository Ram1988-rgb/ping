              ...
              <form action="" method="POST">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="password" name="oldpassword" class="form-control" id="oldpassword" placeholder="" data-validation="required,server" data-validation-url="<?php echo base_url('admin/dashboard/checkPassword')?>">
                  </div>
                  <div class="form-group">
