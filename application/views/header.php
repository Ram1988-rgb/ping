    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url($module)?>/cms/index" class="nav-link <?php if($this->router->fetch_class() =='cms'){?>active<?php }?>">
              <i class="fas fa-user-friends"></i>
              <p>CMS</p>
            </a>            
          </li>
          <li class="nav-item">
            <a href="<?php echo base_url($module)?>/reports/index" class="nav-link <?php if($this->router->fetch_class() =='reports'){?>active<?php }?>">
              <i class="fas fa-user-friends"></i>
              <p>Report</p>
            </a>            
          </li>
          <li class="nav-item">
            <a href="<?php echo base_url($module)?>/api/index" class="nav-link <?php if($this->router->fetch_class() =='api'){?>active<?php }?>">
              <i class="fas fa-user-friends"></i>
              <p>Api List</p>
            </a>            
          </li>
          <li class="nav-item <?php if($this->router->fetch_class() =='logs'){?>menu-is-opening menu-open<?php }?>" >
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url($module)?>/logs/index" class="nav-link <?php if($this->router->fetch_class() =='logs'){?>active<?php }?>">
                  <i class="fas fa-user-friends"></i>
                  <p>Customer Log</p>
                </a>            
              </li>
          ...
          <?php 
           $Settings =false;
          if($this->router->fetch_class() =='paymenttype'||
            $this->router->fetch_class() =='paymentduration'||
            $this->router->fetch_class() =='notification'||
            $this->router->fetch_class() =='smsemail'||
            $this->router->fetch_method() =='changepassword'
          ){
            $Settings =true;
          }
          ?>
          <li class="nav-item <?php if($Settings){?>menu-is-opening menu-open<?php }?>" >
            <a href="#" class="nav-link">
            <i class="fas fa-hand-holding-usd"></i>
              <p>
                Settings
