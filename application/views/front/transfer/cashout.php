            ...
            <div class="card card-primary">              
              ...
              <form id="" action="" method="POST">
                ...
                <div class="form-group">
                        <label for="name"><?php echo $this->lang->line("Withdrawal From")?></label><span class="validate-star">*</span>            
                        
                            <input type="radio" name="withdrawl_to" value="CASH" class="form-control" id="withdrawl_to" checked="checked">  Cash
                            <input type="radio" name="withdrawl_to" value="LOAN" class="form-control" id="withdrawl_to">  Loan
                    ...
                    <div class="form-group" style="text-align:center">
                        <div>
                            <label for="name"><?php echo CURRENCY?> <?php echo show_number($current_loan_balance);?></label> 
                        </div>
                        <div>
                            <label for="name">Total Available Loan to Withdraw</label>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="name"><?php echo $this->lang->line("Withdrawal To")?></label><span class="validate-star">*</span> 
