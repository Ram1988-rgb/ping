    ...
    <div class="row align-items-end">
                <div class="col-8">
                    <table class="table" border="1">
                     ...
                     <tr>
                        <td><?php echo $loan_amount = show_number(get_total_loan($this->session->userdata('CUSTOMERID')))?></td>
                        <td><?php echo $loan_transfer =show_number(get_loan_transfer($this->session->userdata('CUSTOMERID')))?></td>
                        <td><?php echo $loan_amount-$loan_transfer;?></td>
                     </tr>
