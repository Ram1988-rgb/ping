...
<div class="content-header">
   <div class="container-fluid">
      <div class="row mb-2">
         <div class="col-sm-6">
            <h1 class="m-0"><img src="<?php echo base_url('assets/icons/all_inboxblack.png'); ?>" class="sidebar_icons" /> <?php echo $this->lang->line('My investment');?></h1>
         </div>
         <!-- /.col -->
         <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
               <li class="breadcrumb-item"><a href="<?php echo base_url('user/dashboard')?>"><?php echo $this->lang->line('Dashboard');?></a></li>
               <li class="breadcrumb-item active"><?php echo $this->lang->line('My investment');?></li>
            </ol>
         </div>
         <!-- /.col -->
      </div>
...
<section class="content">
    ...
    <div class="row align-items-end">
                ...
                <div class="col-4 text-right">
                    <a href="<?php echo base_url('/')?>user/investment"><button type="button" class="btn btn-primary"><?php echo $this->lang->line('Create Investment');?></button></a>
                </div>
            </div>
        ...
        <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <th><?php echo $this->lang->line('Investment Date');?></th>                    
                  ...
                  if($all_record ){
                    ...
                    <tr id="row-<?php echo $record->id?>">
                      ...
                      <td><?php if($record->payment_type_data!='null'){echo JSON_DECODE($record->payment_type_data)->label;}else{echo "--";}?></td>
                      ...
                      <?php if($record->status == 1){ ?>
							...
							<?php } ?> </td>
                     <td>
                        <a href="<?php echo base_url('user/investment/investment_detail/'.$record->id)?>">
