    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="box-shadow p-2 mb-3 text-right">
          <a href="<?php echo base_url('admin/')?>paymenttype/add" class="btn btn-primary">Add Payment Type</a>
        </div>
                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  if($all_record ){
                    ...
                    <td><?php echo $record->description? $record->description: '--';?></td>
                      ...
                      <!--<td>
                        <a href="<?php echo site_url('admin/')?>paymenttype/edit/<?php echo $record->id?>">
