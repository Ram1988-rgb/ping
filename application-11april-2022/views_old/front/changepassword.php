              ...
              <form action="" method="POST">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="password" name="oldpassword" class="form-control" id="oldpassword" placeholder="" data-validation="server" data-validation-url="<?php echo base_url('user/dashboard/checkPassword')?>">
                  </div>
                  <div class="form-group">
