    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <?php }
          if(getModulePermission('4',$this->session->userdata('ADMINID'))){
          ?>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url($module)?>/loan/myloan" class="nav-link <?php if($this->router->fetch_class() =='loan'){?>active<?php }?>">
            <img src="<?php echo base_url('assets/icons/loan.png'); ?>" class="sidebar_icons" />
