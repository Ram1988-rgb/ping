...
class Secureapi extends REST_Controller {
  ...
  public function addbank_post(){
    ...
    if($this->bank_model->addBank($this->input->post())){
      sendNotificationProfileBank($_POST, 'APP');
  ...
  function move_cash_to_wallet_post(){
    $cash_payment_id = $_POST['cash_payment_id'];
    $all_payment_date_id = $_POST['all_payment_date_id'];
  ...
  function deposite_investment_payment_post(){
    $investment_date_id =  $this->input->post('all_payment_date_id');
  ...
  function move_investment_to_wallet_post(){
    $invest_payment_id = $_POST['invest_payment_id'];
    $all_payment_date_id = $_POST['all_payment_date_id'];
  ...
  public function deposite_loan_payment_post(){
    $loan_payment_date_id = $_POST['all_payment_date_id'];
