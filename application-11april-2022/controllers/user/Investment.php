...
class Investment extends MY_Controller {    
    ...
    public function createPlan(){
        ...
        if($this->input->post()){
            ...
            $addId = $this->investment_model->create_plan($this->input->post());
    ...
    public function myinvestment(){
        $_POST['user_id'] = $this->session->userdata('CUSTOMERID');
        $this->data['all_record'] = $this->investment_model->getAllRecord($_POST['user_id']);
    ...
    function investment_payment(){
        $investment_date_id =  $this->input->post('investment_date_id');
